...
/*
 * GBM + EGL + GLES2 scanout for gemini-status.
 * CPU only builds the display list; Adreno 530 rasterizes.
 */
#define _GNU_SOURCE
...
/* Must match gemini-status-font.h */
struct gs_glyph {
	uint32_t cp;
	uint16_t w, h, adv;
	int16_t xoff, yoff;
