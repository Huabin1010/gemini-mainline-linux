#!/bin/bash
# USB gadget: CDC ACM serial + RNDIS (host 192.168.7.1, phone 192.168.7.2).
set -euo pipefail

GADGET_NAME="${GADGET_NAME:-gemini}"
...
setup_gadget() {
	...
	echo "gemini" > strings/0x409/serialnumber
	echo "gemini-mainline" > strings/0x409/manufacturer
	echo "Xiaomi Mi 5 USB Gadget" > strings/0x409/product
